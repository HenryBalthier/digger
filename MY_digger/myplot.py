...
def plot_strategy(price_data, indicators={}, deals=[], curve=[], figname='nameless', marks=[]):
    """
        显示回测结果。
    """
    print "plotting.."
...
def plot_curves(data, colors=[], lws=[], names=[]):
    ...
    figname = './Output/figures/' + str(names) + '.jpg'
    plt.savefig(figname)
    # plt.show()
